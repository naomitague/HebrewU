...
To do this: follow these instructions - get as far as creating a new project
...
You man need to set your working directory first
...
* **add as a R module in an R Markdown file**
